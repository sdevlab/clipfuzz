...
class ConstFieldInstance {
 public:
  ...
  ConstFieldInstance Clone(size_t new_index = kInvalidIndex) const {
    if (new_index == kInvalidIndex) {
      return ConstFieldInstance(message_, descriptor_, index_);
    } else {
      return ConstFieldInstance(message_, descriptor_, new_index);
    }
  }
  ...
  const protobuf::Message* get_message() const { return message_; }
...
class FieldInstance : public ConstFieldInstance {
 public:
  ...
  FieldInstance Clone(size_t new_index = kInvalidIndex) const {
    if (new_index == kInvalidIndex) {
      return FieldInstance(message_, descriptor_, index_);
    } else {
      return FieldInstance(message_, descriptor_, new_index);
    }
  }
