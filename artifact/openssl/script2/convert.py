import sys
sys.path.append('/graphfuzz/openssl/gfuzz/src')
...
def main():
    ...
    create_graph(graph, 0, 0, 0, None, [(1,0)], data_len.to_bytes(4,'little')+data+plus)
    create_graph(graph, 1, 2, 1, [(0,0)], [(2,0)], None)
    create_graph(graph, 2, 1, 1, [(1,0)], None, None)
