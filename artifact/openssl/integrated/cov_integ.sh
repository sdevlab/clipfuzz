...
INCLUDE="-I/src/openssl_cov/include -I/src/openssl_cov/fuzz -I../gfuzz/header"
LIB="/src/openssl_cov/libssl.a /src/openssl_cov/libcrypto.a"
...
clang++-12  \
    ...
    -fno-exceptions -Wstring-conversion -stdlib=libc++ -fsanitize-coverage=0 \
    -c ${PROTO_CC} \
    -o ${PROTO_CC}.o
...
clang++-12 \
    ...
    -I${LIB_PROTO_BUILD}/external.protobuf/include \
    -I${LIB_PROTO_BUILD}/external.googletest/include \
    -fno-exceptions -Wstring-conversion -stdlib=libc++ -fsanitize=address,fuzzer-no-link \
    -Wno-deprecated-register \
