# /graphfuzz/re2/gfuzz
rm schema.json fuzz_exec.cpp fuzz_write.cpp cache.json
gfuzz gen cpp schema.yaml .

# fuzz_exec
sed -i -e '1,22d' fuzz_exec.cpp
sed -i -e '1r header/gfuzz_re2.h' fuzz_exec.cpp
...
# fuzz_write
sed -i '/gfuzz_re2.h/d' fuzz_write.cpp
...
sed -i "/#INSERT_HERE_1/r ./header/gfuzz_re2.h" fuzz_write.cpp
