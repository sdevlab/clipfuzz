...
clang++-12  \
    ...
    -fno-exceptions -Werror -Wall -Wstring-conversion -std=c++14 -fsanitize-coverage=0 \
    -fsanitize=address \
    -c ${PROTO_CC} \
    -o ${PROTO_CC}.o
...
clang++-12 \
    ...
    -I${LIB_PROTO_BUILD}/external.protobuf/include \
    -I${LIB_PROTO_BUILD}/external.googletest/include \
    -fno-exceptions -Wall -Wstring-conversion -std=c++14 -fsanitize=address,fuzzer-no-link \
    ${INCLUDE} \
    -o ${CPP_DRIVER}.o \
    -c ${CPP_DRIVER}
...
CXXFLAGS="-fno-omit-frame-pointer -gline-tables-only -DFUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION -fsanitize=address -fsanitize-address-use-after-scope -std=c++14"
