...
CURL_INSTALL="/graphfuzz/curl_install"
...
clang++-12 \
    ...
    -I${LIB_PROTO_BUILD}/external.protobuf/include \
    -I${LIB_PROTO_BUILD}/external.googletest/include \
    -fno-exceptions -Wall -Wstring-conversion -g -std=c++14 -fsanitize=address,fuzzer-no-link \
    ${INCLUDE} \
    -o ${CPP_DRIVER}.o \
    -c ${CPP_DRIVER}
...
clang++-12 \
    -fno-exceptions -Wall -Wstring-conversion -g -fsanitize=address,fuzzer \
    ${CPP_DRIVER}.o -lz \
